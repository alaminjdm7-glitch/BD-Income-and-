...
<head>
    ...
    <title>Loading...</title> <!-- অ্যাপ নাম ডায়নামিক হবে -->
    ...
    <style>
        ...
        .modal-in { background: white; width: 85%; max-width: 320px; padding: 25px; border-radius: 20px; }
...
<body>
    ...
    <div id="loader-screen">
        ...
        <div class="app-loading-text">INITIALIZING...</div>
    </div>
    ...
    <div id="main-app">
        ...
        <!-- RUNTIME TIMER -->
        <div class="runtime-strip">RUNTIME: <span id="runtime-display">Loading...</span></div>
        ...
        <div class="header-pro">
            <div class="top-nav">
                <div class="user-block">
                    ...
                    <div>
                        <div style="font-weight:700; font-size:18px;" id="u_name">Loading...</div>
        ...
        <img id="banner-area" style="width:calc(100% - 40px); margin:20px 20px 0; border-radius:15px; display:none;" src="">

        <!-- PAGE 1: HOME -->
        <div id="p-home" class="page active">
            <!-- Custom Task Removed as requested -->
            <div class="section-title"><i class="fas fa-bolt" style="color:#f1c40f"></i> Available Tasks</div>
            <div id="task-list"><div style="text-align:center; padding:30px; color:#aaa;">Loading...</div></div>
        </div>
        ...
        <div id="p-prof" class="page">
            ...
            <div style="padding:0 20px;">
                <button onclick="openWdModal()" style="width:100%; background:var(--dark); color:white; padding:15px; border:none; border-radius:15px; font-weight:bold; font-size:16px;">Request Withdrawal <i class="fas fa-arrow-right"></i></button>
            </div>
        </div>
        ...
        <div class="btm-nav">
            ...
            <i class="fas fa-chart-line nav-it" onclick="go('p-leader', this)"></i>
    ...
    <script>
        ...
        let minWd = 100, curTask = null, allInboxData = [];

        function init() {
            // 1. LOAD APP SETTINGS (Name, Logo, Maintenance)
            db.ref('app_settings').on('value', s => {
                ...
                if(d) {
                    ...
                    if(d.banner) { document.getElementById('banner-area').style.display='block'; document.getElementById('banner-area').src=d.banner; }
            ...
            // Remove Loader after slight delay
            setTimeout(() => {
                const settings = db.ref('app_settings'); 
                settings.once('value').then(snap => {
                    const d = snap.val();
                    // If maintenance is NOT active, show app
        ...
        function checkMaintenance(settings) {
            ...
            if(settings.maintenance && settings.maintenance.active === true) {
                ...
                mainDiv.style.display = 'none'; // Hide app
                document.getElementById('loader-screen').style.display = 'none'; // Hide loader
                ...
                if(settings.maintenance.endTime) {
                    ...
                    maintInterval = setInterval(() => {
                        ...
                        if(diff <= 0) {
                            // Time up, Auto Turn On
                            timerDiv.style.display = 'none';
                            maintDiv.style.display = 'none';
                            mainDiv.style.display = 'block';
                            // Update DB to turn off maintenance
        ...
        function openWdModal() { document.getElementById('wd-modal').style.display='flex'; }
        ...
        function filterInbox(type, btn) {
            ...
            const filtered = allInboxData.filter(i => {
                ...
                if(type==='money') return i.type==='Withdraw';
            });
            ...
            filtered.forEach(i => {
                ...
                <div class="hist-card" style="border-left-color:${border}">
                    ...
                    <div style="font-weight:700; font-size:14px; margin-top:5px;">${i.taskName || i.method}</div>
